...
\\  $\mathcal{R}$ & - & Within-period interest factor ($1+F_{K}$)
\\  $R$ & - & Between period interest factor ($(1+F_{K}) \daleth$)
\\  $r$ & - & Between-period interest rate ($\approx F_{K} - \delta$)
\\  $\mathfrak{R}_{t+1}$ & - & Between-period Blanchard-adjusted but not growth-adjusted interest factor ($\mathcal{R}_{t+1} \daleth/\Omega $)
\\  $\mathbb{R}_{t+1}$ & - & Between-period growth-adjusted interest factor ($\mathcal{R}_{t+1} \daleth/\Omega \mathbf{\Psi}_{t+1}$)
%\\  $\mathbb{r}$ & - & Between-period growth-adjusted interest rate ($\approx F_{K} - \delta+\log(\underline{\Psi})$)
\end{tabular}
\end{table}
